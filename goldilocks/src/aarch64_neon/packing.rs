...
/// Both lanes are processed in a single ASM block to maximize ILP.
#[inline]
...
/// Truly interleaved dual-lane multiplication and reduction.
/// Processes two multiplications simultaneously, interleaving instructions to hide latency.
...
/// Goldilocks modular square using truly interleaved dual-lane ASM.
#[inline]
fn square(x: uint64x2_t) -> uint64x2_t {
    unsafe {
        ...
        // Use interleaved dual-lane squaring
